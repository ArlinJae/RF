...
class hadtest(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._uisigtype_options = [101, 102]
        # Create the labels list
        self._uisigtype_labels = ['Sine', 'Cosine']
        ...
        self._uifreq_range = qtgui.Range(0, 100, 1, 50, 200)
        self._uifreq_win = qtgui.RangeWidget(self._uifreq_range, self.set_uifreq, "'uifreq'", "eng", float, QtCore.Qt.Horizontal)
