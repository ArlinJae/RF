...
class drone_sim(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "drone_sim")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_short*1, '/Users/jairelan/Documents/RF/drone_intercept/gpssim.bin', True, 0, 0)
...
def main(top_block_cls=drone_sim, options=None):
